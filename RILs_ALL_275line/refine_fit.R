...
qtl <- makeqtl(cross.imp.jit, chr=c(1,5,6,10), pos=c(90.14, 115.19, 5.98, 18.41))
...
#refine plant height
qtl <- makeqtl(cross.imp.jit, chr=c(1,1,1,3,6,10), pos=c(2.86, 91.60, 149.40, 50.90, 53.43 ,16.99))
rqtl <- refineqtl(cross.imp.jit, qtl=qtl, pheno.col=2, formula=y~Q1+Q2+Q3+Q4+Q5+Q6+Q7)
out.fq <- fitqtl(cross.imp.jit, qtl=rqtl, pheno.col=2, get.ests=TRUE, formula=y~Q1+Q2+Q3+Q4+Q5+Q6+Q7)
summary(out.fq)
#interval
