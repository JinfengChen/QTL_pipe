...
def usage():
    test="name"
    message='''
python Fix_Bam_ID_tab2SNP.py --input RILs_ALL_bam_correct --cpu 32
...
def main():
    ...
    markers = read_parents('/rhome/cjinfeng/HEG4_cjinfeng/RILs/QTL_pipe/bin/RILs_ALL_275line_core/NB.RILs.dbSNP.SNPs.Markers')
