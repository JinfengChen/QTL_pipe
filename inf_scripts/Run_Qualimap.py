...
def runjob(script, lines):
    ...
    cmd = 'perl /rhome/cjinfeng/BigData/software/bin/qsub-pbs.pl --maxjob 30 --lines %s --interval 120 --resource nodes=1:ppn=2,walltime=10:00:00,mem=20G -q highmem --convert no %s' %(lines, script)
    #print cmd 
    os.system(cmd)
